...
def give_averages():
    ...
    write_message("% time being", rectangle=(width, height+30), font=font_16)
    write_message("too close", rectangle=(width, height+50), font=font_16)
    
    write_message("avg alerts/min", rectangle=(width, height+80), font=font_16)
    width +=150
    ...
    for index, hours in enumerate(hours_list):
        ...
        write_message("{:.0f}".format(alert), rectangle=(width, height+40), centered=True, font=font_14)
        write_message("{:.1f}".format(popups), rectangle=(width, height+80), centered=True, font=font_14)
        width += 40
        
def draw_Initial_Screen():
    screen.fill((255,255,255))
    write_message("Welcome to Screen distance tracker!", rectangle=(screen_width/2, 20), centered=True, font=font_24)
